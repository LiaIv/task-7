...
Задания в исходном порядке разрезаются на "ленты" длиной T<sub>opt</sub> = 16, которые распределяются по исполнителям. "Разрез ленты" может производиться внутри задания, что означает прерывание данного задания.

Распределим задания последовательно по исполнителям:

**Исполнитель 1:**
- Задание H полностью: 0 → 16 (длительность 16)
- **Итого:** 16 единиц

**Исполнитель 2:**
- Задание G полностью: 0 → 11 (длительность 11)
- Задание F частично: 11 → 16 (5 из 9 единиц)
- **Итого:** 16 единиц

**Исполнитель 3:**
- Задание F частично: 0 → 4 (остаток 4 единицы)
- Задание E полностью: 4 → 12 (длительность 8)
- Задание D частично: 12 → 16 (4 из 6 единиц)
- **Итого:** 16 единиц

**Исполнитель 4:**
- Задание D частично: 0 → 2 (остаток 2 единицы)
- Задание C полностью: 2 → 7 (длительность 5)
- Задание B полностью: 7 → 13 (длительность 6)
- **Итого:** 13 единиц (простой: 13 → 16)

**Исполнитель 5:**
- Задание A полностью: 0 → 4 (длительность 4)
- **Итого:** 4 единицы (простой: 4 → 16)
...
gantt
    ...
    Начало выполнения работ : milestone, m1, 01 00:00, 0h
    section Исполнитель 1
    Задание H         :a1, 01 00:00, 16s
    section Исполнитель 2
    Задание G         :b1, 01 00:00, 11s
    Задание F         :b2, after b1, 5s
    section Исполнитель 3
    Задание F         :c1, 01 00:00, 4s
    Задание E         :c2, after c1, 8s
    Задание D         :c3, after c2, 4s
    section Исполнитель 4
    Задание D         :d1, 01 00:00, 2s
    Задание C         :d2, after d1, 5s
    Задание B         :d3, after d2, 6s
    section Исполнитель 5
    Задание A         :e1, 01 00:00, 4s
    Окончание выполнения работ : milestone, m2, 01 00:00:16, 0h
```

### Детальное распределение:

* **Исполнитель 1:** от 0 до 16 — задание H;
* **Исполнитель 2:** от 0 до 11 — задание G, от 11 до 16 — задание F (часть 1);
* **Исполнитель 3:** от 0 до 4 — задание F (часть 2), от 4 до 12 — задание E, от 12 до 16 — задание D (часть 1);
* **Исполнитель 4:** от 0 до 2 — задание D (часть 2), от 2 до 7 — задание C, от 7 до 13 — задание B;
* **Исполнитель 5:** от 0 до 4 — задание A;
